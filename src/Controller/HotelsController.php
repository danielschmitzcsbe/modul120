...
class HotelsController extends AppController
{
    ...
    public function view($id = null)
    {
        $hotel = $this->Hotels->get($id, [
            'contain' => ['Countries', 'Travels', 'HotelImages']
        ]);
    ...
    public function add()
    {
        ...
        $countries = $this->Hotels->Countries->find('list', ['limit' => 200]);
        $travels = $this->Hotels->Travels->find('list', ['limit' => 200]);
        $this->set(compact('hotel', 'countries', 'travels'));
        $this->set('_serialize', ['hotel']);
    }
